...
public class transFromSuckersTest {
    ...
    public void tarnsformtoSign() throws TransformationException, FileNotFoundException {
        InputStream in = new FileInputStream("SendRequestRequestNoAttach.xml");
        OutputStream out = new FileOutputStream("TRANS.xml");
        test.process(in, out);
    ...
    public void tarnsformHighligthedData() throws TransformationException, FileNotFoundException {
        InputStream in = new FileInputStream("1.xml");
        OutputStream out = new FileOutputStream("TRANS.xml");
        test.process(in, out);
    }
    ...
    @Test
    public void process4testfromstupidGuide() {
        val test = transFromSuckers()
        val wr = FileWriter("input.xml")
    ...
    @Test
    public void process4test2fromstupidGuide() {
        val test = transFromSuckers()
        val wr = FileWriter("input.xml")
        val write = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                "<!-- \n" +
    ...
    @Test
    public void process4test2fromsHabr() {
        val test = transFromSuckers()
        val wr = FileWriter("input.xml")
    ...
    @Test
    public void process4test22fromsHabr() {
        val test = transFromSuckers()
        val wr = FileWriter("input.xml")
        wr.close()
    ...
    @Test
    public void process4testonlysenderfromsHabr() {
        val test = transFromSuckers()
